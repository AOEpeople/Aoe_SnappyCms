...
class Aoe_LayoutEditor_Model_Config extends Mage_Core_Model_Config_Base {
     ...
     * @var string
     */
    const CACHE_ID = 'aoe_layouteditor_cache';
     ...
     * @var string
     */
    const CONFIGURATION_FILENAME = 'aoe_layouteditor.xml';
